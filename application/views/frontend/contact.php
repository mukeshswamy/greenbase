        ...
        <div class="row">
            <div class="col-md-6">
                <div class="contact-text mr-bottom-40">
                    The Green Base Corporate HQ is situated across a sprawling 35 acres of prime land with</br>abundant
                ...
                <div class="contact-text">
                    ...
                    Hiranandani Gardens, Powai, Mumbai – 400076, MH, India.</br>
                    <span class="call-span"><img src=<?php echo base_url('assets/images/call.svg');?> alt="call"
                            class="call"></span><span>999999999</span>
                </div>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="right-content-wrapper">
                <img src=<?php echo base_url('assets/images/resume.jpg');?> alt="resume" class="resume-img">
            </div>
        </div>
    </div>
</section>
